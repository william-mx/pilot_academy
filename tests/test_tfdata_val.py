...
# Point to your existing split directory name
SPLIT = "split_20260122_122820"  # <-- set this to your real folder name
...
def main():
    ...
    for p in [split_dir, train_path, val_path, all_path, IMAGES_DIR, LABEL_TO_ID_PATH]:
        if not p.exists():
    ...
    def _fmt_leaf(t):
        # Handles Tensor / RaggedTensor / SparseTensor-ish objects
...
print("OK: val tf.data pipeline runs.")
